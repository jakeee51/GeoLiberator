...
##GeoLiberator("123 AVENUE & COOPER STREET, MANHATTAN 11220").getStreet(mode=mSet)
...
##CC = "314 WEST 40 ST (DIV OF PAROLE), NEW YORK 10018"
##GeoLiberator(CC).getAddress(mode=mSet)
